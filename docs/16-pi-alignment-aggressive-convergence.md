...
| {{claude_md}}/{{memory}} 空管道 | prompt.py:12, 153-154, 170-171 + system_prompt.md:78-79 | 历史项：旧静态 memory prompt builder 已由 `MemoryService.static_prompt()` / `memory/prompts.py` 取代 |
