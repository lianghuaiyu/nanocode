...
def test_tool_definitions_derived_from_spec_in_order():
    ...
    assert names[:9] == ["read_file", "write_file", "edit_file", "list_files", "grep_search",
                         "run_shell", "sandbox_shell", "skill", "web_fetch"]
...
def test_handlers_derived_from_spec():
    ...
    for host_routed in ("agent", "skill", "enter_plan_mode", "exit_plan_mode",
